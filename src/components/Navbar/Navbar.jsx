...
const Navbar = () => {
    ...
    return (
        <nav
            className="bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 text-white sticky top-0 z-50 shadow-md transition-all duration-300">
                    ...
                    <div className="md:hidden flex items-center space-x-4">
                        ...
                        {!signIn ? (
                            ...
                            <div ref={dropdownRefMobile} className="relative">
                                ...
                                {isDropdownOpen && (
                                    <div
                                        className="absolute right-0 mt-2 bg-white text-black shadow-lg rounded-md z-50 w-40">
                                        <AccountDropdown/>
                                    </div>
                                )}
                            </div>
